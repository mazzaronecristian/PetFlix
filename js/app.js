...
function pickAndPlotValues(idValue, idLabel) {
  ...
  if (field_value.value != "" && field_label.value != "") {
    if (values[0] == 0) values[0] = field_value.value;
    else values.push(eval(field_value.value));
    if (labels[0] == 0) labels[0] = field_label.value;
    else labels.push(field_label.value);
